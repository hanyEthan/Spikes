...
namespace XCore.Utilities.Utilities
{
    public static class XCrypto
    {
        ...
        public static Stream EncryptToDES( Stream value )
        {
            ...
            {
                NLogger.Error( "XUtilities.XCrypto.EncryptToDES ... Exception: " + x );
                return null;
            }
        }
        public static Stream DecryptFromDES( Stream value )
        {
            ...
            {
                NLogger.Error( "XUtilities.XCrypto.DecryptFromDES ... Exception: " + x );
                return null;
            }
        }
        ...
        #endregion
        #region SHA
        public static string EncryptToSHAHash( string value )
        {
            SHA256 mySHA256 = SHA256Managed.Create();
            byte[] hashValue;

            //compute hash from the bytes of text
            hashValue = mySHA256.ComputeHash( Encoding.ASCII.GetBytes( value ) );
