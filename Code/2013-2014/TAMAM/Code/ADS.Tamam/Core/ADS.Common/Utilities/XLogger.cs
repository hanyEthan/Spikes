...
namespace ADS.Common.Utilities
{
    ...
    public static class XLogger
    {
        ...
        private class XLogEntry
        {
            ...
            public XLogEntry( DateTime time , string message , string context , Enums.LogStatus status , Enums.LogSettings logSettings ) : this( time , message , context , status )
            {
        ...
        {
            return Trace( message , XLogger.Enums.LogSettings.Normal );
        }
        public static bool Trace( string message , params string[] parameters )
        {
            return Trace( HandleStringParameters( message , parameters ) );
        }
        public static bool Trace( string message , XLogger.Enums.LogSettings settings )
        {
        ...
        public static bool Info( string message , XLogger.Enums.LogSettings settings )
        {
        ...
        public static bool Warning( string message , XLogger.Enums.LogSettings settings )
        {
        ...
        {
            return Error( message , XLogger.Enums.LogSettings.Normal );
        }
        public static bool Error( string message , params string[] parameters )
        {
            return Error( HandleStringParameters( message , parameters ) );
        }
        public static bool Error( string message , XLogger.Enums.LogSettings settings )
        {
        ...
        private static bool Initialize()
        {
            ...
            try
            {
                ILogTarget logger = ( Settings.Type & Enums.LogType.File ) == Enums.LogType.File ? ( ILogTarget ) new FileLog() :
        ...
        {
            int stackDepth = logSettings == Enums.LogSettings.TransientCaller ? 4 : 4;
