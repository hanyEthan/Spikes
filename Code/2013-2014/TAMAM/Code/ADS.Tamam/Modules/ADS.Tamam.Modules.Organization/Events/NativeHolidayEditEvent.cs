...
{
    [Serializable]
    public class NativeHolidayEditEvent : EventCell, IXIncludable
    {
        #region Properties

        public Holiday OldHoliday { get; set; }
        public Holiday UpdatedHoliday { get; set; }

        #endregion

        # region cst..

        public NativeHolidayEditEvent()
            : base()
        {

        }
        public NativeHolidayEditEvent( Holiday oldHoliday, Holiday updatedHoliday )
            : base()
        {
            this.OldHoliday = oldHoliday;
            this.UpdatedHoliday = updatedHoliday;
        }
        ...
        public override bool Process()
        {
            ...
            foreach ( var personId in allPeople )
            {
                ...
                // Native Holidays..
                TamamServiceBroker.AttendanceHandler.HandleNativeHolidays( personId, OldHoliday.StartDate, OldHoliday.EndDate, SystemRequestContext.Instance );
                TamamServiceBroker.AttendanceHandler.HandleNativeHolidays( personId, UpdatedHoliday.StartDate, UpdatedHoliday.EndDate, SystemRequestContext.Instance );
            }
        ...
        {
            return OldHoliday != null && UpdatedHoliday != null;
        }
