...
{
    [Serializable]
    public class NativeHolidayCreateEvent : EventCell, IXIncludable
    {
        #region Properties
        ...
        public NativeHolidayCreateEvent() : base()
        {

        }
        public NativeHolidayCreateEvent( Holiday holiday ) : base()
        {
        ...
        public override bool Process()
        {
            ...
            {
                // Leave
                var responseLeaveRecalculate = TamamServiceBroker.LeavesHandler.RecalculateLeaveCredit( id, SystemRequestContext.Instance );
                ...
                // Excuse
                var responseExcuseRecalculate = TamamServiceBroker.LeavesHandler.RecalculateExcuseDuration( id, SystemRequestContext.Instance );
                ...
                // Native Holidays..
                TamamServiceBroker.AttendanceHandler.HandleNativeHolidays( id, Holiday.StartDate, Holiday.EndDate, SystemRequestContext.Instance );
            }
