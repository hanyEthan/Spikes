...
using XCore.Framework.Infrastructure.Messaging.Pools.Repositories;
using XCore.Framework.Infrastructure.Messaging.Pools.Repositories.Unity;

namespace XCore.Framework.Infrastructure.Messaging.Pools.Handlers
{
                                                                                               ...
                                                                                               where TSettings : IPoolDataUnitySettings, new()
    {
        ...
        public int Create( PoolMessage message )
        {
            try
            {
                ...
                {
                    dataHandler.MP.CreateAsync( message );
                    dataHandler.Save();
                }
                return message.Id;
            }
