...
namespace XCore.Services.Security.Core.DataLayer.Context.Configurations
{
    ...
    {
        public static void HandleClaimConfiguration(this ModelBuilder modelentity)
        {
            modelentity.Entity<Claim>(entity =>
            {
                #region table.

                entity.ToTable(Constants.TableClaims, Constants.DBSchema);
                ...
                entity.Property(x => x.Map).HasColumnName("Map");
